...
from .tools.read_oss_file import get_oss_object, create_oss_bucket, put_oss_object
...
async def query_func(
    ...
    **kwargs,
    ...
    toolkit.register_tool_function(create_oss_bucket)
    toolkit.register_tool_function(put_oss_object)
